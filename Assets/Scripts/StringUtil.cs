...
namespace StyleStar
{
    public static class Util
    {
        ...
        public static Color ParseFromHex(string input)
        {
            ...
            r = int.Parse(input.Substring(0, 2), System.Globalization.NumberStyles.HexNumber) / 255.0f;
            g = int.Parse(input.Substring(2, 2), System.Globalization.NumberStyles.HexNumber) / 255.0f;
            b = int.Parse(input.Substring(4, 2), System.Globalization.NumberStyles.HexNumber) / 255.0f;
